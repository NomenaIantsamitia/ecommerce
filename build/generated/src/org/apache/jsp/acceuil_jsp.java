...
public final class acceuil_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("                                  <span class=\"error-message\" id=\"priceError\">Le quantites doit etre positif  </span>\n");
      ...
      out.print( session.getAttribute("num") );
      out.write(";\n");
      out.write("         document.getElementById('formulaire').addEventListener('submit', function(event) {  \n");
      out.write("             let qtt = document.getElementById(\"qtt\").value;\n");
